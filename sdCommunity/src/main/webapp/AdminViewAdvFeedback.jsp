...
<%@page import="sdCommunity.advUser.feedback.AdvFeedbackDTO"%>
...
<body>
	...
	<div class="container">
		...
		<hr>
		<div class="col" >
			<div style="font-weight: 600!important;">Advertisement Agency feedback of sdCommunity<br></div>
		</div>
		</div>
		<div class="scroll" style="border: 1px solid gray; border-radius: 10px;" >
				<table class="table table-striped" style="height: 100px;width: 100%;border: 1px;">
					 ...
					 <%
					 List<AdvFeedbackDTO> afs = AdvFeedbackDAO.getAdvAllfeedback();
					 for(AdvFeedbackDTO af : afs){
					 %>
					 <tr>
					 	<td><%=af.getTid() %></td>
					 	<td><%=af.getUid() %></td>
