...
try {
    suid = Integer.parseInt(uid);
} catch (NumberFormatException e) {
    // Handle the case where the string is not a valid integer
    // For example, you could set a default value or display an error message
    suid = -1; // Default value or some meaningful indicator of an error
}
%>
<head>
	...
	<div class="container-xl" id="ref" style="color: white; margin-top: 20px;">
		<div class="row">
			<div class="col"  style="text-align: center;">
				...
				<%
				List<DTOFollower> liFollowed = DAOuser.folowed(suid);
			...
			<div class="col"  style="text-align: center;">
				...
				<%
				List<DTOFollower> liFollowers = DAOuser.folower(suid);
